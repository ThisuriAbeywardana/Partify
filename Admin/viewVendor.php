...
<div class="container">
    ...
    <div class="tabel3">
                    <?php
                        ...
                        <thead>
                        <tr>
                        <th class='col col1'>vendor ID</th>
                        ...
                        while($row=mysqli_fetch_assoc($vendors)){
                                ...
                                echo '<tr><td>'.$row['spId'].'</td><td>'.$row['name'].'</td><td>'.$row['catering'].'</td><td>'.$row['photography'].'</td><td>'.$row['videograpghy'].'</td><td>'.$row['decoration'].'</td>';
                                echo '<td>';
